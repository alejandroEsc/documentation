...
- [`spec.helmRepositoryName`](../../../reference/crd#helmrepositoryname): Name of the Helm repository where the Redpanda chart is located.
...
|  The Redpanda Operator could be deployed in a different namespace to the Cluster or Console resources.|The updated Redpanda Operator must be deployed in the same namespace as the Redpanda custom resource.
